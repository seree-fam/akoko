...
contract Akoko {
    ...
    event OrderPlaced(uint256 indexed id, Status status, uint256 amount, string recipient);
    ...
    function placeOrder(uint256 _id, string memory _recipient, uint256 _usdcAmount) public {
        ...
        emit OrderPlaced(_id, Status.Unpaid, _usdcAmount, _recipient);
    }
